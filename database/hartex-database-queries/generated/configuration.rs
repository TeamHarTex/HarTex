...
{ pub mod general_plugin_enabled
...
}pub fn general_plugin_enabled() -> GeneralPluginEnabledStmt
{ GeneralPluginEnabledStmt(cornucopia_async::private::Stmt::new("SELECT
    configuration -> 'plugins' -> 'general' -> 'enabled'
FROM
    \"Nightly\".\"GuildConfigurations\"
WHERE
    guild_id = $1")) } pub struct
GeneralPluginEnabledStmt(cornucopia_async::private::Stmt); impl GeneralPluginEnabledStmt
{ pub fn bind<'a, C:
GenericClient,T1:
