...
pub struct CachedUserSelectById<'a> {
    pool: &'a PgPool,
    query: Option<
        QueryAs<
            'a,
            Postgres,
            crate::tables::discord_frontend::NightlyCachedUsers,
            PgArguments,
        >,
    >,
}
impl<'a> CachedUserSelectById<'a> {
    ...
    pub async fn all(
        ...
        Vec<crate::tables::discord_frontend::NightlyCachedUsers>,
    > {
        self.query
            .ok_or(
                crate::result::Error::Generic(
